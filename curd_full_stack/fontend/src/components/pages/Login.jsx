      ...
      <div className="container-fluid">
        <div className="row py-3 a1">
          ...
          <div className="col-sm-4 b1 my-4">
            <center>
              <h1 style={{ color: '#fdc700' }} className=" my-4" >Login <AiFillBank style={{color:"red"}}/> </h1>
              <input
              value={email}
              ...
              <Link to="/farget"><button  className="border border-none mt-2" style={{background:'orange',width:'50%',color:'blue',height:'35px',borderRadius:'5px'}}>Link Farget password</button></Link>
              <Link to="/fargetpassword"><button  className="border border-none mt-2" style={{background:'orange',width:'50%',color:'blue',height:'35px',borderRadius:'5px'}}>Otp Farget password</button></Link>
            
              <div>
               
               <button onClick={onLoginPress} className="form-control w-100 mt-2" style={{background:'#fdc700'}}>Login</button>
               
             </div>
             <br/>
             <center className="text-light">
                <b style={{color:'black'}}>Don't have an account? </b><a href="/sign">Sign Up Here</a><br/>
                <button className='border border-none mt-3' onClick={loginwithgoogle}> <FcGoogle className='fs-1'/>Sign Width Google</button>
              </center>
